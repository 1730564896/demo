      ...
      <el-card>
        <el-tabs>
          ...
          <el-tab-pane label="个人详情">
            ...
            <!-- 动态组件component，它通过 is属性来绑定需要显示在该位置的组件，is属性可以直接为注册组件的组件名称即可 -->
          </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    async saveUser() {
      this.$refs.userForm.validate().then(async() => { await saveUserDetailById({ ...this.userInfo, password: this.userInfo.password2 }) })
